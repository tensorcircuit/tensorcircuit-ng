...
- Validate randomized-compiling candidate caches against the concrete gate matrix and dtype to preserve equivalence for same-named gates with different parameters.
